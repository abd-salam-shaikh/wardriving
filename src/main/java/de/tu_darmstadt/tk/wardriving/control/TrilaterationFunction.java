...
public class TrilaterationFunction implements MultivariateJacobianFunction {
    ...
    /**
     * Calculate and return Jacobian function Actually return initialized
     * function
     *
     * Jacobian matrix, [i][j] at J[i][0] = delta_[(x0-xi)^2 + (y0-yi)^2 -
     * ri^2]/delta_[x0] at J[i][1] = delta_[(x0-xi)^2 + (y0-yi)^2 -
     * ri^2]/delta_[y0] partial derivative with respect to the parameters passed
     * to value() method
     *
     */
