...
public class TrilaterationFunctionTest {
    ...
    @Test
    public void trilaterationWithSignalTransformation() throws Exception {
        double[][] positions = new double[][]{{2.0, 2.0}, {3.0, 2.0}, {2.0, 1.0}, {3.0, 1.0}};
        double[] rssi = new double[]{-75.0, -41.0, -89.0,-49.0};
        ...
        System.out.println("***********************************************************************************");
        System.out.println("Centroid results");
        System.out.println("RSSI After transformation into distances: " );
        System.out.print(distances);
        double[] expectedPosition = new double[]{2.8687041168031264, 18.310451429679336};
    ...
    public void trilaterationTestCentroid() throws Exception {
        double[][] positions = new double[][]{{2.0, 2.0}, {3.0, 2.0}, {2.0, 1.0}, {3.0, 1.0}};
        double[] distances = new double[]{1.0, 1.0, 1.0, 1.0};

        TrilaterationFunction trilaterationFunction = new TrilaterationFunction(positions, distances);
        LeastSquaresSolver solver = new LeastSquaresSolver(trilaterationFunction, new LevenbergMarquardtOptimizer());

        System.out.println("Centroid results");
        double[] expectedPosition = new double[]{2.5, 1.5};
        Optimum optimum = solver.solve();
        testResults(expectedPosition, 0.0001, optimum);
    }
    ...
    public void testResults(double[] expectedPosition, final double delta, Optimum optimum) {
